...
stdenv.mkDerivation rec {
  ...
  configureFlags = lib.optionals (with stdenv; buildPlatform != hostPlatform && hostPlatform.isFreeBSD) [
  ...
  #  substituteInPlace Makefile.am --replace-fail "EXTRA_PROGRAMS = check_libinotify" ""
  #'';
